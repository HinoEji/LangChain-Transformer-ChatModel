...
class TransformerChatModel(BaseChatModel):
    ...
    def _stream(
        ...
        **kwargs: Any,
        ...
        transformer_streamer = TransformerStreamer(
            tokenizer = self.tokenizer,
            buffer_size = 5
        )
        
        iterator = self._stream_transformer(messages, **kwargs)
        yield from transformer_streamer(iterator)
...
class GPTOSSModel(TransformerChatModel):
    ...
    '''
        ...
        reasoning_effort = parsed_response["final_answer"].lower()
